...
import com.oc.maker.create.avatar2.databinding.ActivityLanguageBinding
...
import com.oc.maker.create.avatar2.utils.SystemUtils.setPreLanguage
...
class LanguageActivity : AbsBaseActivity<ActivityLanguageBinding>() {
    ...
    @Inject
    lateinit var providerSharedPreference: com.oc.maker.create.avatar2.utils.SharedPreferenceUtils
...
//            binding.imvDone.setImageResource(R.drawable.ic_tick)
    ...
    private fun setRecycleView() {
        var i = 0
        lateinit var x: com.oc.maker.create.avatar2.data.model.LanguageModel
        if (!codeLang.equals("")) {
