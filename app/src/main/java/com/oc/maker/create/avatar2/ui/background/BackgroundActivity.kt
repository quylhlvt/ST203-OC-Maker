...
import com.oc.maker.create.avatar2.databinding.ActivityBackgroundBinding
import com.oc.maker.create.avatar2.dialog.ChooseColorDialog
import com.oc.maker.create.avatar2.dialog.DialogExit
import com.oc.maker.create.avatar2.dialog.DialogSpeech
import com.oc.maker.create.avatar2.ui.background.adapter.BackGroundTextAdapter
import com.oc.maker.create.avatar2.ui.background.adapter.ColorAdapter
import com.oc.maker.create.avatar2.ui.background.adapter.ColorTextAdapter
import com.oc.maker.create.avatar2.ui.background.adapter.FontAdapter
import com.oc.maker.create.avatar2.ui.background.adapter.ImageAdapter
import com.oc.maker.create.avatar2.ui.background.adapter.StikerAdapter
...
import com.oc.maker.create.avatar2.utils.pickImage
import com.oc.maker.create.avatar2.utils.saveBitmap
import com.oc.maker.create.avatar2.utils.setLayoutParam
    ...
    private fun initDrawView() {
        binding.drawView.apply {
            ...
            setOnDrawListener(object :
                com.oc.maker.create.avatar2.custom.listener.listenerdraw.OnDrawListener {
                override fun onAddedDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {
                    viewModel.updateCurrentCurrentDraw(draw)
                    viewModel.addDrawView(draw)
                    viewModel.setIsFocusEditText(false)
                }

                override fun onClickedDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {
                    viewModel.setIsFocusEditText(false)
                    hideKeyboard()
                }

                override fun onDeletedDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {
                    if (draw.isCharacter) {
                ...
                override fun onDragFinishedDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {
                    viewModel.setIsFocusEditText(false)
                }

                override fun onTouchedDownDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {
                    viewModel.updateCurrentCurrentDraw(draw)
                    viewModel.setIsFocusEditText(false)
                }

                override fun onZoomFinishedDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {}

                override fun onFlippedDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {
                    viewModel.setIsFocusEditText(false)
                }

                override fun onDoubleTappedDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {}

                override fun onHideOptionIconDraw() {}

                override fun onUndoDeleteDraw(draw: List<com.oc.maker.create.avatar2.custom.Draw?>) {}

                override fun onUndoUpdateDraw(draw: List<com.oc.maker.create.avatar2.custom.Draw?>) {}

                override fun onUndoDeleteAll() {}

                override fun onRedoAll() {}

                override fun onReplaceDraw(draw: com.oc.maker.create.avatar2.custom.Draw) {}

                override fun onEditText(draw: com.oc.maker.create.avatar2.custom.DrawableDraw) {}

                override fun onReplace(draw: com.oc.maker.create.avatar2.custom.Draw) {}
            })
        }
    }
}