...
import com.oc.maker.create.avatar2.databinding.DialogRateBinding
...
class DialogRate(context: Activity) : com.oc.maker.create.avatar2.base.BaseDialog<DialogRateBinding>(context, false) {
    var i = 0
