...
import com.oc.maker.create.avatar2.ui.view.ViewActivity
import com.oc.maker.create.avatar2.utils.CONST
import com.oc.maker.create.avatar2.utils.CONST.NAME_SAVE_FILE
...
import com.oc.maker.create.avatar2.utils.share.telegram.TelegramSharing
import com.oc.maker.create.avatar2.utils.share.whatsapp.IdGenerator.generateIdFromUrl
import com.oc.maker.create.avatar2.utils.share.whatsapp.StickerBook.addPackIfNotAlreadyAdded
import com.oc.maker.create.avatar2.utils.share.whatsapp.StickerPack
import com.oc.maker.create.avatar2.utils.share.whatsapp.WhatsappSharingActivity
...
class MyCreationActivity : WhatsappSharingActivity<ActivityMyCreationBinding>() {
        ...
        AvatarAdapter().apply {
            onClick = { pos, type ->
                when (type) {
                    ...
                    "longclick" -> {
                        this@MyCreationActivity.binding.rcvAvatar.setMargins(0,8.dp(this@MyCreationActivity),0,150)
                        checkLongClick = true
        ...
        DesignAdapter().apply {
            onClick = { pos, type ->
                when (type) {
                    ...
                    "longclick" -> {
                        this@MyCreationActivity.binding.rcvDesign.setMargins(0,8.dp(this@MyCreationActivity),0,10)
                        checkLongClick = true
                        this@MyCreationActivity.checkLongClick = true
    ...
    fun hideLongClick() {
        this@MyCreationActivity.binding.rcvAvatar.setMargins(0,8.dp(this@MyCreationActivity),0,0)
        this@MyCreationActivity.binding.rcvDesign.setMargins(0,8.dp(this@MyCreationActivity),0,0)
